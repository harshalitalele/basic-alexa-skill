...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speechText = 'Welcome, you want me to look for something or memorize something related to a new thing for you?';
...
const SaveIntentHandler = {
    ...
    handle(handlerInput) {
        var test = handlerInput.requestEnvelope.request.intent.slots.Object.value;
